...
public class Book {
	...
	public String toString() {
		return "Book [isbn=" + isbn + ", publishingYear=" + publishingYear + ", publisherName=" + publisherName
				+ ", authors=" + authors + ", title=" + title + ", amountInLibrary=" + amountInLibrary
				+ ", amountInUse=" + amountInUse + ", subject=" + subject + ", language=" + language + ", maxDaysInUse="
				+ maxDaysInUse + ", archivingDate=" + archivingDate + "]";
	}
